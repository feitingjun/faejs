...
export function Provider(props) {
    return (_jsxs(Context.Provider, { value: { dispatcher }, children: [Object.keys(props.models).map((namespace) => {
                return (_jsx(Executor, { hook: props.models[namespace], namespace: namespace, onUpdate: (val) => {
